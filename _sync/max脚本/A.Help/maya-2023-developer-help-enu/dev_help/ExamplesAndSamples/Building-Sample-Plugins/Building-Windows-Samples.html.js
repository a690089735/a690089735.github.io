...
<script type=\"text/javascript\" src=\"../../../scripts/prettify.js\"></script><script src=\"../../../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><meta http-equiv=\"Content-Style-Type\" content=\"text/css\" /><meta name=\"generator\" content=\"pandoc\" /><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../../../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Building examples on Windows</title>\n\
   </head>\n\
   <body height=\"100%\"><div class=\"body_content\" id=\"body-content\"><style type=\"text/css\">code{white-space: pre;}</style><script>$(document).ready(function() { yepnope.injectJs(\"./scripts/multireflink.js\"); });</script><script>$(document).ready(function () { prettyPrint(); } );</script><script></script><script></script><div id=\"reflinkdiv\"></div>\n\
      <div>\n\
         <div class=\"head\">\n\
            <h1>Building examples on Windows</h1>\n\
         </div>\n\
\n\
<div class=\'section\'><a id=\"building-examples-on-windows\"></a></div>\n\
<blockquote>\n\
<p><strong>Important:</strong> You need to set up your environment as described in <a href=\'#!/url=./dev_help/Setting-up-your-build/Windows-environment-64-bit-.html\' title=\'\'>Setting up your build environment</a> before building the examples.</p>\n\
</blockquote>\n\
<p>On Windows, the plug-in examples are located in <span class=\'code\'>%DEVKIT_LOCATION%\\devkit\\plug-ins</span>, and the standalone application examples are located in <span class=\'code\'>%DEVKIT_LOCATION%\\devkit\\applications</span>. Each example is in its own dedicated directory.</p>\n\
<p>To build an example, open a command prompt and change directory to its directory.</p>\n\
...
</pre></div><p>To build an example, run <span class=\'code\'>cmake</span> once to generate a Visual Studio Project for the example:</p>\n\
<div class=\"codeBlock\"><pre class=\"prettyprint\">&gt; cmake -H. -Bbuild -G &quot;Visual Studio 16 2019 Win64&quot;\n\
