...
class Siki(object):
    ...
    async def get_course_detail_list(self, courseid, coursename):
        ...
        response = await self.session.get(url, headers={"Referer": "http://www.sikiedu.com/my/courses/learning", "user-agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.137 Safari/4E423F"})
        html = etree.HTML(await response.text())
