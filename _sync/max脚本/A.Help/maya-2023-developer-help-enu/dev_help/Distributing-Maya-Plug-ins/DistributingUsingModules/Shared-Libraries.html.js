...
<li>macOS: The library (ending in <span class=\'code\'>.dylib</span>) must go into Maya&#39;s own <span class=\'code\'>Maya.app/Contents/MacOS</span> directory. When linking the library you must use the <span class=\'code\'>-install_name @executable_path/libName.dylib</span> flag on macOS10.4, or the the <span class=\'code\'>-rpath</span> flag on macOS 10.5.</li>\n\
</ul>\n\
