...
function ufe_ref_initializeToc(forceTrigger) {\n\
    ...
    ufe_ref_adsk_ref_toc.initNavTree(\'pages.html\', tocPrefix);\n\
...
<tr id=\"row_0_\" class=\"even\"><td class=\"entry\"><span style=\"width:16px;display:inline-block;\">&#160;</span><a class=\"el\" href=\"#!/url=./ufe_ref/ufe_philosophy.html\" target=\"_self\">UFE Concepts and Architecture</a></td><td class=\"desc\"></td></tr>\n\
</table>\n\
</div><!-- directory -->\n\
</div><!-- contents -->\n\
</div><!-- doc-content -->\n\
