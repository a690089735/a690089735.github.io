...
可惜图片不能用相对路径插入.需要先上传到图床(比如博客所在仓库).本页下方的图片,使用了:`![按钮们](\{\{site.pimg\}\}image-20200801142727668.png)`
...
![按钮们]({{site.pimg}}image-20200801142727668.png)
...
![2020年8月2日22点52分]({{site.pimg}}2020年8月2日22点52分.gif)
