...
<div class=\"contents\">\n\
\n\
<p><a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_legacy.html\" title=\"MGeometryLegacy stores the collection of MGeometryData arrays which describe a Maya surface...\">MGeometryLegacy</a> stores the collection of <a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_data.html\" title=\"This class allows storage of arbitrary data which is formated to be specifically suitable for usage u...\">MGeometryData</a> arrays which describe a Maya surface, including per-component data such as UV mapping and colour.  \n\
...
<dl class=\"params\"><dt>Parameters</dt><dd>\n\
  <table class=\"params\">\n\
    <tr><td class=\"paramdir\">[in]</td><td class=\"paramname\">geom</td><td><a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_legacy.html\" title=\"MGeometryLegacy stores the collection of MGeometryData arrays which describe a Maya surface...\">MGeometryLegacy</a> to copy. </td></tr>\n\
  </table>\n\
  </dd>\n\
</dl>\n\
\n\
...
<dl class=\"params\"><dt>Parameters</dt><dd>\n\
  <table class=\"params\">\n\
    <tr><td class=\"paramdir\">[in]</td><td class=\"paramname\">rhs</td><td><a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_legacy.html\" title=\"MGeometryLegacy stores the collection of MGeometryData arrays which describe a Maya surface...\">MGeometryLegacy</a> to copy</td></tr>\n\
  </table>\n\
  </dd>\n\
</dl>\n\
<dl class=\"section return\"><dt>Returns</dt><dd><a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_legacy.html\" title=\"MGeometryLegacy stores the collection of MGeometryData arrays which describe a Maya surface...\">MGeometryLegacy</a> copied into. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
...
<p>The surface geometry may consist of more than one <a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_primitive.html\" title=\"MGeometryPrimitive is a class describes the topology used for accessing MGeometryData. \">MGeometryPrimitive</a>, each representing an array of primitives. For example, if the surface was composed of both triangles and quads there might be one <a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_primitive.html\" title=\"MGeometryPrimitive is a class describes the topology used for accessing MGeometryData. \">MGeometryPrimitive</a> for the triangles and a second for the quads. The <em>arrayNumber</em> parameter is used to select between these.</p>\n\
<p>Each <a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_primitive.html\" title=\"MGeometryPrimitive is a class describes the topology used for accessing MGeometryData. \">MGeometryPrimitive</a> contains indices which are used to map the <a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_data.html\" title=\"This class allows storage of arbitrary data which is formated to be specifically suitable for usage u...\">MGeometryData</a> returned by the other methods of this class onto the primitives. For example, if the returned <a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_primitive.html\" title=\"MGeometryPrimitive is a class describes the topology used for accessing MGeometryData. \">MGeometryPrimitive</a> is for an array of triangles it will contain three indices for each triangle. Those indices can be used to index into the position data returned by the <a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_legacy.html#a117087d6021defde4f3202650c48f3ce\" title=\"Get the position data for this surface. \">position()</a> method, the normal data returned by the <a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_legacy.html#aa6680785c2ecf1772013b55775fbcc2d\" title=\"Get the normal data for this surface. \">normal()</a> method, and so on.</p>\n\
<dl class=\"params\"><dt>Parameters</dt><dd>\n\
  <table class=\"params\">\n\
...
<p>This array allows you to correlate <a class=\"el\" href=\"#!/url=./cpp_ref/class_m_geometry_legacy.html\" title=\"MGeometryLegacy stores the collection of MGeometryData arrays which describe a Maya surface...\">MGeometryLegacy</a> entries with the corresponding component on the Maya surface (e.g. for meshes, this array will contains the vertex id).</p>\n\
