...
<script type=\"text/javascript\" src=\"../../scripts/prettify.js\"></script><script src=\"../../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><meta http-equiv=\"Content-Style-Type\" content=\"text/css\" /><meta name=\"generator\" content=\"pandoc\" /><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Write script fragments and fragment graphs to control render passes in the viewport</title>\n\
   </head>\n\
   <body height=\"100%\"><div class=\"body_content\" id=\"body-content\"><style type=\"text/css\">code{white-space: pre;}</style><script>$(document).ready(function() { yepnope.injectJs(\"./scripts/multireflink.js\"); });</script><script>$(document).ready(function () { prettyPrint(); } );</script><script></script><script></script><div id=\"reflinkdiv\"></div>\n\
      <div>\n\
         <div class=\"head\">\n\
            <h1>Write script fragments and fragment graphs to control render passes in the viewport</h1>\n\
         </div>\n\
\n\
<div class=\'section\'><a id=\"write-script-fragments-and-fragment-graphs-to-control-render-passes-in-the-viewport\"></a></div>\n\
<div class=\'section\'><a id=\"introduction\"></a><h2 id=\"introduction\">Introduction</h2></div>\n\
<p>Maya&#39;s viewport relies on a system of fragments (scripts serialized in an XML format) of two different types: * <strong>Shade fragments</strong> wrap code fragments in a real-time shading language (GLSL, HLSL or Cg) together with their input and output definitions in XML. Such fragments are connected into nested shade fragment graphs which are ultimately compiled by Maya into final shaders executed by the GPU. * <strong>Script fragments</strong> define sequences of imperative <a href=\'#!/url=./dev_help/Viewport-2-0-API/Write-fragments-and-fragment/Script-fragment-commands.html\' title=\'\'>script commands</a> which are interpreted by Maya at runtime and ultimately result in GPU state changes and draw calls. Script fragments can also be connected into nested script fragment graphs which determine the high-level control flow.</p>\n\
<p>A set of script fragment and fragment graph XML files is provided with the Maya installation in the <span class=\'code\'>bin/ScriptFragment</span> subdirectory of your installation directory.</p>\n\
<p>In Maya 2020 and earlier releases, <span class=\'code\'>default.xml</span> was the top-level fragment graph that defined the default implementation of the beauty pass (including scene and post-effect passes but excluding shadow map and various UI and HUD passes). It connected various fragments and fragment graphs such as <span class=\'code\'>Maya_3d_Renderer.xml</span>, which connected fragment graphs such as <span class=\'code\'>HoldOutPasses.xml</span> and <span class=\'code\'>Maya_PostEffects.xml</span>, which in turn connected fragments and fragment graphs such as <span class=\'code\'>mayaUIDrawPass.xml</span> and <span class=\'code\'>Maya_SSAO.xml</span>, and so forth. Some of the fragments referenced in these graphs are implemented as hardcoded C++ procedural fragments.</p>\n\
<p>In newer versions of Maya, <span class=\'code\'>default.xml</span> and its dependencies are still shipped with Maya but the default beauty pass implementation has been redesigned and can no longer be described by a single script fragment graph.</p>\n\
<p>In an <span class=\'code\'><a href=\"javascript:void(0)\" data-symbol=\"MRenderOverride\" class=\"a_multireflink\" data-reflinkdata=\"[{&quot;path&quot;:&quot;cpp_ref/class_m_h_w_render_1_1_m_render_override.html&quot;,&quot;title&quot;:&quot;C++ API Reference&quot;,&quot;relpathtoroot&quot;:&quot;../../&quot;},{&quot;path&quot;:&quot;py_ref/class_open_maya_render_1_1_m_render_override.html&quot;,&quot;title&quot;:&quot;Python 2.0 API Reference&quot;,&quot;relpathtoroot&quot;:&quot;../../&quot;}]\">MRenderOverride</a></span> plug-in, the beauty pass is represented with the <span class=\'code\'><a href=\"javascript:void(0)\" data-symbol=\"MSceneRender\" class=\"a_multireflink\" data-reflinkdata=\"[{&quot;path&quot;:&quot;cpp_ref/class_m_h_w_render_1_1_m_scene_render.html&quot;,&quot;title&quot;:&quot;C++ API Reference&quot;,&quot;relpathtoroot&quot;:&quot;../../&quot;},{&quot;path&quot;:&quot;py_ref/class_open_maya_render_1_1_m_scene_render.html&quot;,&quot;title&quot;:&quot;Python 2.0 API Reference&quot;,&quot;relpathtoroot&quot;:&quot;../../&quot;}]\">MSceneRender</a></span> operation. When constructing the <span class=\'code\'><a href=\"javascript:void(0)\" data-symbol=\"MSceneRender\" class=\"a_multireflink\" data-reflinkdata=\"[{&quot;path&quot;:&quot;cpp_ref/class_m_h_w_render_1_1_m_scene_render.html&quot;,&quot;title&quot;:&quot;C++ API Reference&quot;,&quot;relpathtoroot&quot;:&quot;../../&quot;},{&quot;path&quot;:&quot;py_ref/class_open_maya_render_1_1_m_scene_render.html&quot;,&quot;title&quot;:&quot;Python 2.0 API Reference&quot;,&quot;relpathtoroot&quot;:&quot;../../&quot;}]\">MSceneRender</a></span>, the <span class=\'code\'>fragmentName</span> parameter can be used to provide the name of a custom script fragment or fragment graph to override the default Maya beauty pass implementation, for example:</p>\n\
<div class=\"codeBlock\"><pre class=\"prettyprint lang-python\">class FragmentRenderOverride(omr.MRenderOverride):\n\
\n\
...
</pre></div><p>You can use the XML files shipped in the <span class=\'code\'>bin/ScriptFragment</span> directory as a reference when writing your custom fragment however modifying files in that directory directly is not recommended, to avoid corrupting Maya.</p>\n\
