...
https://doc.qt.io/qt-6.2/qtwidgets-layouts-flowlayout-example.html
...
class FlowLayout(QLayout):
    ...
    def _do_layout(self, rect, test_only=False):
        ...
        new_height = y + line_height - rect.y() + 10
...
if __name__ == '__main__':
    import sys
    import random
    from PySide6.QtWidgets import QApplication, QPushButton, QScrollArea, QVBoxLayout, QWidget, QGroupBox
    ...
    for i in range(2):
        ...
        l = FlowLayout(margin=20,spacing=-1)
        ...
        l.addWidget(QPushButton(random.choice(['大大青蛙挖法实打实打算','大苏打','撒大大3423微软4223的文32132二位大啊的2大撒旦请问3'])))
