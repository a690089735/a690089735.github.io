...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script>\n\
      <title>C++ API Reference: AbcExport/AbcExport.cpp</title>\n\
      \n\
	  \n\
      \n\
      \n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>C++ API Reference: AbcExport/AbcExport.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">else</span> <span class=\"keywordflow\">if</span> (arg == <span class=\"stringliteral\">&quot;-uvo&quot;</span> || arg == <span class=\"stringliteral\">&quot;-uvsonly&quot;</span>)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                jobArgs.writeMeshes = <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">                jobArgs.writeUVs= <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">                jobArgs.writeGeometry = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">                jobArgs.noNormals = <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">                jobArgs.writeCurvesGroup = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">                jobArgs.writeTransforms = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">                jobArgs.writeLocators = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">                jobArgs.writeParticles = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">                jobArgs.writeCameras = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">                jobArgs.writeNurbsSurfaces = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">                jobArgs.writeNurbsCurves = <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            absoluteFilePath.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#ac14aefbfe38c2711256eb8c14a3194ee\">setRawFullName</a>(absoluteFile.<a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a7a4d2fada6eb436c6e74f1e62212c218\">resolvedPath</a>());</div>\n\
...
<div class=\"line\">                }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <a name=\"_a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> abcFilePlug = alembicNode.findPlug(<span class=\"stringliteral\">&quot;abc_File&quot;</span>, <span class=\"keyword\">true</span>);</div>\n\
...
<div class=\"line\">                            error += absoluteFile.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a9484f49594e6f95729f1be1608a6ae8f\">resolvedFullName</a>();</div>\n\
<div class=\"line\">                            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a4ddbe97e58a90e1ab05d45a62c006cf0\">MGlobal::displayError</a>(error);</div>\n\
<div class=\"line\">                            <span class=\"keywordflow\">return</span> MS::kFailure;</div>\n\
<div class=\"line\">                        }</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> abcLayerFilePlug = alembicNode.findPlug(<span class=\"stringliteral\">&quot;abc_layerFiles&quot;</span>, <span class=\"keyword\">true</span>);</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">if</span> (!abcLayerFilePlug.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ab7ec149d38b7c29ca55c5aa7b407d8f9\">isNull</a>())</div>\n\
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <a name=\"_a49\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_string_array_data.html\">MFnStringArrayData</a> fnSAD( abcLayerFilePlug.<a name=\"a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ada03566ab064058c7ef435ae306d3809\">asMObject</a>() );</div>\n\
<div class=\"line\">                    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> layerFilenames = fnSAD.array();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">for</span>( <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> l = 0; l &lt; layerFilenames.length(); l++ )</div>\n\
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html\">MFileObject</a> thisAlembicFile;</div>\n\
...
<div class=\"line\">                        thisAlembicFile.<a name=\"a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a4b3d5deec3dc9475f712c8e0f2f4d9a2\">setResolveMethod</a>(MFileObject::MFileResolveMethod::kInputFile);</div>\n\
<div class=\"line\">                        thisAlembicFile.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#ac14aefbfe38c2711256eb8c14a3194ee\">setRawFullName</a>(layerFilenames[l]);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                        <span class=\"keywordflow\">if</span> (!thisAlembicFile.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#aa9100e4c626877b706ca9fc67a35c562\">exists</a>())</div>\n\
<div class=\"line\">                        {</div>\n\
<div class=\"line\">                            <span class=\"keywordflow\">continue</span>;</div>\n\
<div class=\"line\">                        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                        <span class=\"keywordflow\">if</span> (thisAlembicFile.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a9484f49594e6f95729f1be1608a6ae8f\">resolvedFullName</a>() == absoluteFile.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a9484f49594e6f95729f1be1608a6ae8f\">resolvedFullName</a>())</div>\n\
<div class=\"line\">                        {</div>\n\
<div class=\"line\">                            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> error = <span class=\"stringliteral\">&quot;Can&#39;t export to an Alembic file which is in use: &quot;</span>;</div>\n\
<div class=\"line\">                            error += absoluteFile.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_file_object.html#a9484f49594e6f95729f1be1608a6ae8f\">resolvedFullName</a>();</div>\n\
<div class=\"line\">                            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a4ddbe97e58a90e1ab05d45a62c006cf0\">MGlobal::displayError</a>(error);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordtype\">double</span> startTime = sampleRanges.begin()-&gt;startTime;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">for</span>(<span class=\"keyword\">auto</span>&amp; elem : pattern)</div>\n\
<div class=\"line\">            {</div>\n\
<div class=\"line\">                elem += startTime;</div>\n\
<div class=\"line\">            }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <span class=\"keywordtype\">double</span> strideTime = sampleRanges.begin()-&gt;strideTime;</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">for</span>(<span class=\"keyword\">auto</span>&amp; elem : pattern)</div>\n\
<div class=\"line\">                    {</div>\n\
<div class=\"line\">                        elem += strideTime;</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            <a name=\"a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a6d81d38246555884897fb153c93aaf42\">MGlobal::getActiveSelectionList</a>(activeList);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"_a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_computation.html\">MComputation</a> computation;</div>\n\
<div class=\"line\">    computation.<a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_computation.html#a21a0632b8283a671cd8f90fd82a99843\">beginComputation</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status;</div>\n\
<div class=\"line\">    <a name=\"_a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html\">MFnPlugin</a> plugin(obj, <span class=\"stringliteral\">&quot;Alembic&quot;</span>, ABCEXPORT_VERSION, <span class=\"stringliteral\">&quot;Any&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a name=\"a61\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a2c877a6e116f8fd3a6e76387403c023a\">MGlobal::executeCommandOnIdle</a>(<span class=\"stringliteral\">&quot;AlembicCreateUI&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
