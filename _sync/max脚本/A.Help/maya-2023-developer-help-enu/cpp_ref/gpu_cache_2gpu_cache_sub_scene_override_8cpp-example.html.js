...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script>\n\
      <title>C++ API Reference: gpuCache/gpuCacheSubSceneOverride.cpp</title>\n\
      \n\
	  \n\
      \n\
      \n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>C++ API Reference: gpuCache/gpuCacheSubSceneOverride.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        assert(gsMainThreadId == std::this_thread::get_id());</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (gsMainThreadId != std::this_thread::get_id())</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Find the Viewport 2.0 index buffer in the cache. Returns nullptr if not found.</span></div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_index_buffer.html\">MIndexBuffer</a>* buffer = <span class=\"keyword\">nullptr</span>;</div>\n\
<div class=\"line\">        lookup(indices, buffer);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> buffer;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// Find the Viewport 2.0 vertex buffer in the cache. Returns nullptr if not found.</span></div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_vertex_buffer.html\">MVertexBuffer</a>* buffer = <span class=\"keyword\">nullptr</span>;</div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        pointer = <span class=\"keyword\">nullptr</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        };</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keyword\">struct </span>BufferKeyHash</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\">        };</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"keyword\">struct </span>BufferKeyEqualTo</div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\"><span class=\"keyword\">class </span>SubNodeUserData : <span class=\"keyword\">public</span> <a name=\"_a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_user_data.html\">MUserData</a></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"keyword\">public</span>:</div>\n\
...
<div class=\"line\">    {}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    ~SubNodeUserData()<span class=\"keyword\"> override</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{}</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (renderItem) {</div>\n\
<div class=\"line\">            <span class=\"keyword\">auto</span> userDataBase = renderItem-&gt;<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_render_item.html#a70171d1dc55d8353aea17312740526aa\">getCustomData</a>();</div>\n\
<div class=\"line\">            <span class=\"keyword\">auto</span> userData = <a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_shared_ptr.html#af29f103f35779b78156c1d8360ca5836\">MSharedPtr&lt;SubNodeUserData&gt;::dynamic_pointer_cast</a>(userDataBase);</div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> displayStyle = context.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_frame_context.html#acd5ce60bbd3d03181b1ad681023ff44d\">getDisplayStyle</a>();</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"_a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html\">MRenderer</a>* renderer = MRenderer::theRenderer();</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!renderer) <span class=\"keywordflow\">return</span> <span class=\"keyword\">nullptr</span>;</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> <a name=\"_a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_manager.html\">MShaderManager</a>* shaderMgr = renderer-&gt;<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html#a4603e18a1b89b798a2e4a4f36d9b5125\">getShaderManager</a>();</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!shaderMgr) <span class=\"keywordflow\">return</span> <span class=\"keyword\">nullptr</span>;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> shaderMgr-&gt;<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_manager.html#a8e4ad27d691969622af2b05d8c6213d9\">getStockShader</a>(MShaderManager::k3dFatPointShader);</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> shaderMgr-&gt;<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_manager.html#a75e397b8d02f3da09024156fe70eed44\">getFragmentShader</a>(<span class=\"stringliteral\">&quot;mayaDashLineShader&quot;</span>, <span class=\"stringliteral\">&quot;&quot;</span>, <span class=\"keyword\">false</span>,</div>\n\
<div class=\"line\">        <span class=\"keyword\">nullptr</span>, BoundingBoxPlaceHolderDrawCallback);</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        shader = <span class=\"keyword\">nullptr</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">void</span> setDiffuseColor(<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_instance.html\">MShaderInstance</a>* shader, <span class=\"keyword\">const</span> <a name=\"_a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html\">MColor</a>&amp; diffuseColor)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (shader) {</div>\n\
<div class=\"line\">        <span class=\"comment\">// Color</span></div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> <span class=\"keywordtype\">float</span> color[3] = {diffuseColor.<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html#a4788d82c901b9367dd5c0daff8a7616b\">r</a>, diffuseColor.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html#a8cf17d727651616de6f2b79ef32170cd\">g</a>, diffuseColor.<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html#a83fc1af92e29717b4513d121b0c72c7d\">b</a>};</div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">if</span> (diffuseColor.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_color.html#a4aec1a5be9d9a4a394a2e49e9744286e\">a</a> &lt; 1.0f) {</div>\n\
...
<div class=\"line\">            shader-&gt;<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_instance.html#a6b65d9b284fc376f7f3458b36c29d8a0\">setIsTransparent</a>(<span class=\"keyword\">true</span>);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span> {</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">static</span> <a name=\"_a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> sHwInstancingPlug;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (sHwInstancingPlug.<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#ab7ec149d38b7c29ca55c5aa7b407d8f9\">isNull</a>()) {</div>\n\
<div class=\"line\">        <a name=\"_a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html\">MSelectionList</a> sl;</div>\n\
<div class=\"line\">        sl.<a name=\"a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a23929aeafb29672f2652128eac9c4dec\">add</a>(<span class=\"stringliteral\">&quot;hardwareRenderingGlobals.hwInstancing&quot;</span>);</div>\n\
<div class=\"line\">        <a name=\"_a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> stat = sl.<a name=\"a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a4cdb668fdd6feafe9b296a80cfca26f0\">getPlug</a>(0, sHwInstancingPlug);</div>\n\
<div class=\"line\">        MStatAssert(stat);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> sHwInstancingPlug.<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a69b4092a85b4edf58b7d50f331cc38cf\">asBool</a>() &amp;&amp; Config::useHardwareInstancing();</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">//==============================================================================</span></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">operator</span> bool ()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> (fTemplate.get() != <span class=\"keyword\">nullptr</span>);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_instance.html\">MShaderInstance</a>* <span class=\"keyword\">get</span>() <span class=\"keyword\">const</span></div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        newShader.reset(fTemplate-&gt;clone(), [deleter](<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_instance.html\">MShaderInstance</a>* shader){</div>\n\
<div class=\"line\">            (*deleter)(shader);</div>\n\
<div class=\"line\">        });</div>\n\
...
<div class=\"line\">        ptr.reset(shader, [](<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_shader_instance.html\">MShaderInstance</a>* shader){</div>\n\
<div class=\"line\">            shaderTemplateDeleter(shader);</div>\n\
<div class=\"line\">        });</div>\n\
...
<div class=\"line\">        : fShader(shader), fDeleter(nullptr), fTimeInSeconds(timeInSeconds)</div>\n\
<div class=\"line\">    {}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keyword\">struct </span>MaterialGraphHash</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">        : fMasterData(nullptr),</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        fMasterData = <span class=\"keyword\">nullptr</span>;</div>\n\
<div class=\"line\">        fInstanceId = 0;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">          fRenderItem(nullptr),</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        assert(name.<a name=\"a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 0);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <a name=\"_a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_mask.html\">MSelectionMask</a> gpuCacheMask(ShapeNode::selectionMaskName);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> addToContainer(<a name=\"_a43\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_sub_scene_container.html\">MSubSceneContainer</a>&amp; container)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        assert(fRenderItem);</div>\n\
<div class=\"line\">        container.<a name=\"a44\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_sub_scene_container.html#a3868473990e1902a2929a48acd2746d8\">add</a>(fRenderItem);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            <span class=\"keyword\">auto</span> null_data = <a name=\"_a45\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_shared_ptr.html\">MSharedPtr&lt;SubNodeUserData&gt;</a>(<span class=\"keyword\">nullptr</span>);</div>\n\
<div class=\"line\">            fRenderItem-&gt;setCustomData(null_data);</div>\n\
<div class=\"line\">            container.<a name=\"a46\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_sub_scene_container.html#ab8634382a216e26abb0b47c55d5eb4b6\">remove</a>(fName);</div>\n\
<div class=\"line\">            fRenderItem = <span class=\"keyword\">nullptr</span>;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> setWorldMatrix(<span class=\"keyword\">const</span> <a name=\"_a47\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html\">MMatrix</a>&amp; worldMatrix)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> setCustomData(<span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_shared_ptr.html\">MSharedPtr&lt;SubNodeUserData&gt;</a>&amp; userData)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (fUserData != userData) {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (fRenderItem) {</div>\n\
<div class=\"line\">                fRenderItem-&gt;setCustomData(userData);</div>\n\
<div class=\"line\">            }</div>\n\
...
<div class=\"line\">            <span class=\"keywordflow\">if</span> (fRenderItem) {</div>\n\
<div class=\"line\">                <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_mask.html\">MSelectionMask</a> pointsForGravityMask(<a name=\"a48\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_mask.html#acffca3b33fddce63d3220bc7487e879da973e7813e5ba338103dc014a3037bc7a\">MSelectionMask::kSelectPointsForGravity</a>);</div>\n\
...
<div class=\"line\">    <span class=\"comment\">// If the hardware instance data is nullptr, the render item will never be instanced.</span></div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> fHardwareInstanceData.get() != <span class=\"keyword\">nullptr</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        fRenderItem-&gt;setCustomData(fUserData);</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_render_item.html#a688a4360e982358b90610f58d4eef49e\">MRenderItem::RenderItemType</a>         type()<span class=\"keyword\"> const      </span>{ <span class=\"keywordflow\">return</span> fType; }</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_geometry.html#a08260379b97fd733e30ea92e891ede1e\">MGeometry::Primitive</a>                primitive()<span class=\"keyword\"> const </span>{ <span class=\"keywordflow\">return</span> fPrimitive; }</div>\n\
<div class=\"line\">    <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_shared_ptr.html\">MSharedPtr&lt;SubNodeUserData&gt;</a>&amp;  userData()<span class=\"keyword\"> const  </span>{ <span class=\"keywordflow\">return</span> fUserData; }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_shared_ptr.html\">MSharedPtr&lt;SubNodeUserData&gt;</a>             fUserData;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        <span class=\"keywordflow\">for</span>(<span class=\"keyword\">const</span> HardwareInstance&amp; hwInstance : fInstances) {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (hwInstance.master-&gt;renderItem()-&gt;name() == renderItem.<a name=\"a49\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_render_item.html#aca2cba4630391c78dcf1a828986160da\">name</a>())</div>\n\
<div class=\"line\">            {</div>\n\
...
<div class=\"line\">                {</div>\n\
<div class=\"line\">                    <a name=\"_a50\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> renderItemParts;</div>\n\
<div class=\"line\">                    renderItemName.<a name=\"a51\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#ac914d138fc96d7065c687a4f8b40c263\">split</a>(<span class=\"charliteral\">&#39;:&#39;</span>, renderItemParts);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (renderItemParts.<a name=\"a52\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() &gt; 1 &amp;&amp; renderItemParts[0].isUnsigned())</div>\n\
<div class=\"line\">                    {</div>\n\
...
<div class=\"line\">    <span class=\"keyword\">struct </span>VisHash</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    <span class=\"comment\">// We ignore the render item&#39;s name and its world matrix.</span></div>\n\
<div class=\"line\">    <span class=\"keyword\">struct </span>VisEqualTo</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        fAttrsAffectTransform.insert( <span class=\"stringliteral\">&quot;offsetParentMatrix&quot;</span> );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"comment\">// Hook model/scene/DG/event callbacks.</span></div>\n\
<div class=\"line\">        fMayaExitingCallback = <a name=\"a53\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_scene_message.html#a44771b834e9a0ad7291ecdcc880106fe\">MSceneMessage::addCallback</a>(</div>\n\
<div class=\"line\">            <a name=\"a54\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_scene_message.html#a4f09127c805cc1f5ee20e67db7b45efaa1efff7ad75eeef5a2ac9e3c0e890dbd0\">MSceneMessage::kMayaExiting</a>, MayaExitingCallback, <span class=\"keyword\">nullptr</span>);</div>\n\
<div class=\"line\">        fSelectionChangedCallback = <a name=\"a55\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_model_message.html#ac4dd423a333cf2a97157987532b36675\">MModelMessage::addCallback</a>(</div>\n\
<div class=\"line\">            <a name=\"a56\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_model_message.html#a4f09127c805cc1f5ee20e67db7b45efaa256632550aa8e279dac1d41927c59d84\">MModelMessage::kActiveListModified</a>, SelectionChangedCallback, <span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">        fTimeChangeCallback = <a name=\"a57\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_d_g_message.html#a0cf2d487672abd947a5abc89ac788789\">MDGMessage::addTimeChangeCallback</a>(</div>\n\
<div class=\"line\">            TimeChangeCallback, <span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">        fRenderLayerChangeCallback = <a name=\"a58\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_event_message.html#a8d22c58b90484867755273c2f7ffc6ec\">MEventMessage::addEventCallback</a>(</div>\n\
...
<div class=\"line\">    ~ModelCallbacks()</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"a59\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_message.html#a50fe995add3ce133b8b56551abb4ed09\">MMessage::removeCallback</a>(fMayaExitingCallback);</div>\n\
...
<div class=\"line\">        <a name=\"a60\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a6d81d38246555884897fb153c93aaf42\">MGlobal::getActiveSelectionList</a>(list);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">        <a name=\"_a61\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html\">MDagPath</a>   dagPath;</div>\n\
<div class=\"line\">        <a name=\"_a62\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html\">MItDag</a>     dagIt;</div>\n\
<div class=\"line\">        <a name=\"_a63\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html\">MFnDagNode</a> dagNode;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0, size = list.<a name=\"a64\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a99dd6a54b909ede1d11702fe58977e2a\">length</a>(); i &lt; size; i++) {</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (list.<a name=\"a65\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a16dda1a34d5f10be257d8421ac6deabd\">getDagPath</a>(i, dagPath) &amp;&amp; dagPath.<a name=\"a66\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a095ae34296e81703965265a42ee783ca\">isValid</a>()) {</div>\n\
<div class=\"line\">                <span class=\"comment\">// Iterate the DAG to find descendant gpuCache nodes.</span></div>\n\
<div class=\"line\">                dagIt.<a name=\"a67\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#ac734f26ff1c92ecec3572a31f5e4435c\">reset</a>(dagPath, <a name=\"a68\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#a1545968b4f810358b53ae9844bce6bd1a6e92a8757afce03be51397f0b518f4c5\">MItDag::kDepthFirst</a>, <a name=\"a69\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7ad409ef3c9033402174590389a6ce18ea\">MFn::kPluginShape</a>);</div>\n\
<div class=\"line\">                <span class=\"keywordflow\">for</span> (; !dagIt.<a name=\"a70\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#a8b6dbf6fbab6f4e7bf50a309124cbf4c\">isDone</a>(); dagIt.<a name=\"a71\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#a73616f002814b8abe6d921db72d7a496\">next</a>()) {</div>\n\
<div class=\"line\">                    <span class=\"keywordflow\">if</span> (dagNode.<a name=\"a72\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dag_node.html#a6b2301b53683a8e8f56dd0b9cb088b0f\">setObject</a>(dagIt.<a name=\"a73\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#afc1c0d71245e763fc566fc1d67ab06ae\">currentItem</a>()) &amp;&amp; dagNode.<a name=\"a74\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a1d0bbd4d50dae591f8e003c0aedc8135\">typeId</a>() == ShapeNode::id) {</div>\n\
<div class=\"line\">                        <span class=\"keyword\">const</span> ShapeNode* shapeNode = (<span class=\"keyword\">const</span> ShapeNode*)dagNode.<a name=\"a75\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#a4f2c53c9d1dcf25a6462c70fb25aead1\">userNode</a>();</div>\n\
<div class=\"line\">                        <span class=\"keywordflow\">if</span> (shapeNode) {</div>\n\
<div class=\"line\">                            currentSelection.insert(std::make_pair(dagIt.<a name=\"a76\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_dag.html#ac4b316731c4019c927aa63731d4749e8\">fullPathName</a>(), shapeNode));</div>\n\
<div class=\"line\">                        }</div>\n\
<div class=\"line\">                    }</div>\n\
<div class=\"line\">                }</div>\n\
<div class=\"line\">            }</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">bool</span> affectTransform( <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>&amp; attr )<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\">    </span>{</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> (fAttrsAffectTransform.find( attr ) != fAttrsAffectTransform.cend());</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">private</span>:</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keyword\">static</span> <span class=\"keywordtype\">void</span> TimeChangeCallback(<a name=\"_a77\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html\">MTime</a>&amp; time, <span class=\"keywordtype\">void</span>* clientData)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        assert(clientData);</div>\n\
...
<div class=\"line\">    std::unordered_set&lt;MString, MStringHash&gt; fAttrsAffectTransform;</div>\n\
<div class=\"line\">};</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">//==============================================================================</span></div>\n\
...
<div class=\"line\"><span class=\"keywordtype\">void</span> WorldMatrixChangedCallback(<a name=\"_a78\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a>&amp; transformNode,</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_message.html#aac763393737ed1a9319009e297e792e3\">MDagMessage::MatrixModifiedFlags</a>&amp; modified,</div>\n\
...
<div class=\"line\">    assert(clientData);</div>\n\
<div class=\"line\">    <a name=\"_a79\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html\">MFnAttribute</a> attr(plug.<a name=\"a80\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a240c26abf3ba7645371553cb130691fa\">attribute</a>());</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>( ModelCallbacks::getInstance().affectTransform(attr.name())) {</div>\n\
<div class=\"line\">        <span class=\"keyword\">static_cast&lt;</span>SubSceneOverride*<span class=\"keyword\">&gt;</span>(clientData)-&gt;dirtyWorldMatrix();</div>\n\
<div class=\"line\">    }</div>\n\
...
<div class=\"line\">                <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_shared_ptr.html\">MSharedPtr&lt;SubNodeUserData&gt;::make</a>(subNode)</div>\n\
<div class=\"line\">            );</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">            ));</div>\n\
<div class=\"line\">            fSnappingItem-&gt;setDrawMode(<a name=\"a81\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_geometry.html#a9a325db332d24e6105fe3b48a94604c3a3b28d66a728ec358f3aae323b2c24fa9\">MHWRender::MGeometry::kSelectionOnly</a>);</div>\n\
...
<div class=\"line\">                MGeometry::kLines</div>\n\
<div class=\"line\">            ));</div>\n\
<div class=\"line\">            fActiveWireItem-&gt;setDrawMode((<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_geometry.html#a9a325db332d24e6105fe3b48a94604c3\">MGeometry::DrawMode</a>)(MGeometry::kWireframe | MGeometry::kSelectionHighlighting)); </div>\n\
...
<div class=\"line\">        fVisibility = dagPath.<a name=\"a82\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a27f324b7f2643119a7542e39101601d1\">isVisible</a>();</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        fIsSelected = (displayStatus == kActive) ||</div>\n\
...
<div class=\"line\"><span class=\"comment\">//==============================================================================</span></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a name=\"_a83\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_px_sub_scene_override.html\">MPxSubSceneOverride</a>* SubSceneOverride::creator(<span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a>&amp; <span class=\"keywordtype\">object</span>)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">      fShapeNode(nullptr),</div>\n\
...
<div class=\"line\">    fCastsShadowsPlug   = dagNode.<a name=\"a84\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#aac29b4a3b51c9d236175e955638f7153\">findPlug</a>(<span class=\"stringliteral\">&quot;castsShadows&quot;</span>, <span class=\"keyword\">false</span>);</div>\n\
...
<div class=\"line\">    <a name=\"a85\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a422aa5ec02565f757c13fe2873ed25d7\">MDagPath::getAPathTo</a>(<span class=\"keywordtype\">object</span>, dagPath);  <span class=\"comment\">// any path</span></div>\n\
<div class=\"line\">    fInstanceAddedCallback = <a name=\"a86\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_message.html#a9c301d5a30d9424eea522166b283a98d\">MDagMessage::addInstanceAddedDagPathCallback</a>(</div>\n\
<div class=\"line\">        dagPath, InstanceChangedCallback, <span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">    fInstanceRemovedCallback = <a name=\"a87\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_message.html#aafe921878a14c3ae07f6a453773c59e2\">MDagMessage::addInstanceRemovedDagPathCallback</a>(</div>\n\
<div class=\"line\">        dagPath, InstanceChangedCallback, <span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">    fWorldMatrixChangedCallback = <a name=\"a88\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_message.html#a33a28fd9c6b6fbaa4fefe2c849f76636\">MDagMessage::addWorldMatrixModifiedCallback</a>(</div>\n\
...
<div class=\"line\">    <a name=\"a89\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_message.html#ac637287cc26b707b9e1a175a32f44e29\">MMessage::removeCallbacks</a>(fNodeDirtyCallbacks);</div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">MHWRender::DrawAPI SubSceneOverride::supportedDrawAPIs()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
...
<div class=\"line\">                                      <span class=\"keyword\">const</span> <a name=\"_a90\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_frame_context.html\">MFrameContext</a>&amp;      frameContext)<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
<div class=\"line\">    assert(fShapeNode);</div>\n\
...
<div class=\"line\">        <a name=\"a91\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a6e4195497a9d3f031d159ddb60f94e74\">MDagPath::getAllPathsTo</a>(fObject, nonConstThis-&gt;fInstanceDagPaths);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span> (geometry &amp;&amp; frameContext.<a name=\"a92\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_frame_context.html#a376f1eeaa26e24a893afacff7db169bc\">getLightingMode</a>() == MFrameContext::kLightDefault) {</div>\n\
<div class=\"line\">        <span class=\"comment\">// The world view proj inv matrix.</span></div>\n\
<div class=\"line\">        <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_matrix.html\">MMatrix</a> viewProjInv = frameContext.<a name=\"a93\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_frame_context.html#a71cbe2a3f2dfa967ebc43b5e97456ccb\">getMatrix</a>(MFrameContext::kViewProjInverseMtx);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <span class=\"comment\">// The bounding box in local DAG transform space.</span></div>\n\
<div class=\"line\">        BoundingBoxVisitor visitor(<a name=\"a94\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_anim_control.html#a8cb1e013d828c1d012fee789b14e0060\">MAnimControl::currentTime</a>().as(<a name=\"a95\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html#abceb2331ad056e3c5ad27894199a49eda3091d1a096c28d4993507f167253ebc7\">MTime::kSeconds</a>));</div>\n\
...
<div class=\"line\">                renderer-&gt;<a name=\"a96\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_renderer.html#aac2a5827e6a0ce3333e62ffa7751ba5e\">drawAPIIsOpenGL</a>() ? Frustum::kOpenGL : Frustum::kDirectX);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        fInstanceRenderItems.clear();</div>\n\
<div class=\"line\">        container.<a name=\"a97\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_sub_scene_container.html#ac8bb3912a3ce86b15842e79d0b421204\">clear</a>();</div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">int</span> hardwareInstanceIndex = intersection.<a name=\"a100\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_h_w_render_1_1_m_intersection.html#a2fa1d445309fffa9993954542d8610c0\">instanceID</a>();</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">            dagPath.<a name=\"a101\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#a0803071a27de28ea0eee7fdc7812de95\">set</a>(fInstanceDagPaths[pathIndex]);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (dagPath.<a name=\"a102\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#af321be336f1f2d96ac2273a87cb3c8ab\">length</a>() &gt; 1)</div>\n\
<div class=\"line\">                dagPath.<a name=\"a103\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#ac71eca2b78b8cfc088adc9af6f851dfd\">pop</a>(); <span class=\"comment\">// from shape to xform.</span></div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> <span class=\"keyword\">false</span>;</div>\n\
...
<div class=\"line\">    <a name=\"_a107\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path_array.html\">MDagPathArray</a> paths;</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span> (<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> i = 0; i &lt; paths.<a name=\"a108\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); i++) {</div>\n\
...
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> node = dagPath.<a name=\"a109\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_path.html#ae024049dad815f2f186e6a4fead8be51\">node</a>();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"comment\">// Monitor the parents and re-register callbacks.</span></div>\n\
<div class=\"line\">            MCallbackId parentAddedCallback = <a name=\"a110\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_message.html#a0cbf1f7d7670e5c7843dc1b8e021664d\">MDagMessage::addParentAddedDagPathCallback</a>(</div>\n\
<div class=\"line\">                dagPath, ParentChangedCallback, <span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\">            MCallbackId parentRemovedCallback = <a name=\"a111\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_dag_message.html#a7b9f16fb02898efdb74ef8e2106f1d53\">MDagMessage::addParentRemovedDagPathCallback</a>(</div>\n\
<div class=\"line\">                dagPath, ParentChangedCallback, <span class=\"keyword\">this</span>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <span class=\"comment\">// Monitor parent display status changes.</span></div>\n\
<div class=\"line\">            MCallbackId nodeDirtyCallback = <a name=\"a112\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_node_message.html#a54c088182daaef8a244e375bc4124458\">MNodeMessage::addNodeDirtyPlugCallback</a>(</div>\n\
