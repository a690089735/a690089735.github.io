...
<div class=\'section\'><a id=\"create-workspace-controls-using-python-with-pyside-bindings\"></a><h2 id=\"create-workspace-controls-using-python-with-pyside-bindings\">Create workspace controls using Python with Pyside bindings</h2></div>\n\
...
<p>To build the workspaceControlCmd example, see the <em>Building the plug-in</em> section of the <a href=\'#!/url=./dev_help/Maya-Python-API/Working-with-Qt/Using-Qt-in-Plug-ins.html\' title=\'\'>Using Qt in Plug-ins</a> topic. After the plug-in is built, load it into Maya and execute the following MEL script:</p>\n\
