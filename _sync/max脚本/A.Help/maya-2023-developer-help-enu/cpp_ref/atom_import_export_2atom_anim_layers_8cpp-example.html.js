...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script>\n\
      <title>C++ API Reference: atomImportExport/atomAnimLayers.cpp</title>\n\
      \n\
	  \n\
      \n\
      \n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>C++ API Reference: atomImportExport/atomAnimLayers.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a name=\"_a0\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = MS::kFailure;</div>\n\
<div class=\"line\">    <a name=\"_a1\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> melCommand = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>(<span class=\"stringliteral\">&quot;atomGetAllLayersOrdered();&quot;</span>);</div>\n\
<div class=\"line\">    mOrderedAnimLayerNames.setLength(0);</div>\n\
<div class=\"line\">    status = <a name=\"a2\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a09e405631e7cf680f8ac9d934ad73434\">MGlobal::executeCommand</a>(melCommand, mOrderedAnimLayerNames, <span class=\"keyword\">false</span>, <span class=\"keyword\">false</span> );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> (status==MS::kSuccess &amp;&amp; mOrderedAnimLayerNames.length() &gt;0);</div>\n\
<div class=\"line\">}</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">if</span>(prevLayerName.<a name=\"a3\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() !=0)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = MS::kFailure;</div>\n\
<div class=\"line\">    <a name=\"_a4\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html\">MStringArray</a> resultArray;</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">for</span>(<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> k = 0; k &lt; resultArray.<a name=\"a5\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); ++k)</div>\n\
<div class=\"line\">    {</div>\n\
...
<div class=\"line\">    status = <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a09e405631e7cf680f8ac9d934ad73434\">MGlobal::executeCommand</a>(melCommand, <span class=\"keyword\">false</span>, <span class=\"keyword\">false</span> );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> (status==MS::kSuccess);</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">        std::string str(fullName.<a name=\"a6\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html#aa9ab612f356c53479afc4c648c9ef94d\">asChar</a>());</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"_a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html\">MSelectionList</a> list;</div>\n\
<div class=\"line\">        list.<a name=\"a8\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a23929aeafb29672f2652128eac9c4dec\">add</a>(animLayers[k]);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span>(list.<a name=\"a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a99dd6a54b909ede1d11702fe58977e2a\">length</a>()!=1) <span class=\"comment\">//if not in the list then not in the scene so create it, and the previous one WILL be in the scene so attach to it</span></div>\n\
<div class=\"line\">        {</div>\n\
...
<div class=\"line\"><span class=\"keywordtype\">bool</span> atomAnimLayers::addAnimLayers(<a name=\"_a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html\">MObjectArray</a> &amp;layers)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">            <a name=\"_a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> nullObject;</div>\n\
...
<div class=\"line\">    <span class=\"keywordflow\">for</span>(<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> k = 0; k &lt; layers.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); ++k)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span>(layers[k].hasFn (<a name=\"a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn.html#a1d1cfd8ffb84e947f82999c682b666a7a2feeef9d7a0ae8bba1f9da9ed24e819b\">MFn::kDependencyNode</a>))</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            <a name=\"_a16\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html\">MFnDependencyNode</a> fnNode (layers[k]);</div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\">        layers.<a name=\"a17\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a92c9d648de48c0e6535fc814d32bb72c\">merge</a>(list);</div>\n\
...
<div class=\"line\"><span class=\"keywordtype\">void</span> atomAnimLayers::getPlugs(<span class=\"keywordtype\">unsigned</span> <span class=\"keywordtype\">int</span> nth, <a name=\"_a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html\">MPlugArray</a> &amp;plugs)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">    attributes.<a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_array.html#a18d06b3d0af1426e654ac2cc1dc86c60\">append</a>(attr);</div>\n\
...
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a name=\"_a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> plug = layer.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_dependency_node.html#aac29b4a3b51c9d236175e955638f7153\">findPlug</a>(attributes[i],<span class=\"keyword\">false</span>, &amp;status);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span>(status== MS::kSuccess)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            plugs.<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html#a12338b7a1987007e931b031646c9b4be\">append</a>(plug);</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">}</div>\n\
...
<div class=\"line\"><span class=\"keywordtype\">void</span> atomAnimLayers::writeAnimLayers(std::ofstream &amp;animFile, atomWriter &amp;writer)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\"><span class=\"keywordtype\">bool</span> atomAnimLayers::readAnimLayers(std::ifstream &amp;readAnim, <span class=\"keywordtype\">char</span> *dataType,atomReader &amp;reader)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span>(plugs.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>() == layers.<a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>())</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> attrObj = attrPlug.<a name=\"a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html#a240c26abf3ba7645371553cb130691fa\">attribute</a>();</div>\n\
<div class=\"line\">        <a name=\"_a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_attribute.html\">MFnAttribute</a> fnLeafAttr (attrObj);</div>\n\
...
<div class=\"line\"><a name=\"_a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_anim_curve_clipboard_item_array.html\">MAnimCurveClipboardItemArray</a>&amp; atomLayerClipboard::getCBItemArray(<span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> &amp;layerName)</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">        <span class=\"keyword\">const</span> <a name=\"_a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html\">MTime</a>&amp; startTime, <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html\">MTime</a>&amp; endTime,</div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> status = MS::kFailure;</div>\n\
<div class=\"line\">    <a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_anim_curve_clipboard.html#af34c0cc340b8211738e45087a7d17672\">MAnimCurveClipboard::theAPIClipboard</a>().<a name=\"a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_anim_curve_clipboard.html#ad5522f028dde0080b753279426415a4a\">clear</a>();</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (MS::kSuccess == <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_anim_curve_clipboard.html#af34c0cc340b8211738e45087a7d17672\">MAnimCurveClipboard::theAPIClipboard</a>().set( itemArray, </div>\n\
...
<div class=\"line\">        {</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">            <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a> msg = <a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string_resource.html#a121315f443a9c4ea512738dc1d39414d\">MStringResource::getString</a>(kPasteFailed, status);</div>\n\
<div class=\"line\">            <a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a4ddbe97e58a90e1ab05d45a62c006cf0\">MGlobal::displayError</a>(msg);</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">return</span> <span class=\"keyword\">false</span>;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">    }</div>\n\
