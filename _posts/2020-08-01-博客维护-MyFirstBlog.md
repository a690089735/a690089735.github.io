...
​	百度和测试花了1小时,做了个生成新文章模板的批处理文件,放在了`_post`文件夹里.双击它,就能按当前的时间创建符合书写规则的md格式的博客文章文件.然后自动用默认程序打开编辑.
...
​	学习到了[TRHX 的个人博客](https://www.itrhx.com/)中的打字机效果.找到了个大佬的js源.打算实现多签名循环显示的效果.
