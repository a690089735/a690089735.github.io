...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script>\n\
      <title>C++ API Reference: iffInfoCmd/iffInfoCmd.cpp</title>\n\
      \n\
	  \n\
      \n\
      \n\
...
function cpp_ref_initializeToc(forceTrigger) {\n\
    ...
    cpp_ref_adsk_ref_toc.initNavTree(\'iff_info_cmd_2iff_info_cmd_8cpp-example.html\', tocPrefix);\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>C++ API Reference: iffInfoCmd/iffInfoCmd.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">iffInfoCmd/iffInfoCmd.cpp</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
...
<div class=\"line\"><span class=\"comment\">// </span></div>\n\
<div class=\"line\"><span class=\"comment\">// Produces the MEL command &quot;iffInfo&quot;.</span></div>\n\
<div class=\"line\"><span class=\"comment\">//</span></div>\n\
<div class=\"line\"><span class=\"comment\">// This command takes the name of an IFF file as an argument. </span></div>\n\
<div class=\"line\"><span class=\"comment\">// The file is opened and read, and general information about the file is returned as a result.</span></div>\n\
<div class=\"line\"><span class=\"comment\">// For example: &quot;iffInfo sphere.iff&quot;. </span></div>\n\
<div class=\"line\"><span class=\"comment\">// </span></div>\n\
<div class=\"line\"><span class=\"comment\"></span></div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keyword\">class </span>iffInfo : <span class=\"keyword\">public</span> <a name=\"_a0\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_px_command.html\">MPxCommand</a></div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\"><span class=\"keyword\">public</span>:</div>\n\
<div class=\"line\">                iffInfo();</div>\n\
<div class=\"line\">        ~iffInfo() <span class=\"keyword\">override</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a7\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>     result;</div>\n\
<div class=\"line\">};</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">iffInfo::iffInfo()</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">iffInfo::~iffInfo() {}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">void</span>* iffInfo::creator()</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> <span class=\"keyword\">new</span> iffInfo;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordtype\">bool</span> iffInfo::isUndoable()<span class=\"keyword\"> const</span></div>\n\
<div class=\"line\"><span class=\"keyword\"></span>{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> <span class=\"keyword\">true</span>;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> iffInfo::undoIt()</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> iffInfo::doIt( <span class=\"keyword\">const</span> <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html\">MArgList</a>&amp; args )</div>\n\
<div class=\"line\">{</div>\n\
...
<div class=\"line\">        displayError (<span class=\"stringliteral\">&quot;Syntax: iffInfo file&quot;</span>);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> bytesPerChannel = reader.getBytesPerChannel ();</div>\n\
...
<div class=\"line\">    result += itoa (w);</div>\n\
<div class=\"line\">    result += <span class=\"stringliteral\">&quot;x&quot;</span>;</div>\n\
<div class=\"line\">    result += itoa (h);</div>\n\
<div class=\"line\">    result += <span class=\"stringliteral\">&quot;\\n&quot;</span>;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (reader.isRGB () || reader.isGrayscale ()) {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (reader.isRGB ()) {</div>\n\
<div class=\"line\">            result += <span class=\"stringliteral\">&quot;RGB&quot;</span>;</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">if</span> (reader.hasAlpha ())</div>\n\
<div class=\"line\">                result += <span class=\"stringliteral\">&quot;A&quot;</span>;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">            result += <span class=\"stringliteral\">&quot;Grayscale&quot;</span>;</div>\n\
<div class=\"line\">        result += <span class=\"stringliteral\">&quot; data with &quot;</span>;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (bytesPerChannel == 2)</div>\n\
<div class=\"line\">            result += <span class=\"stringliteral\">&quot;16&quot;</span>;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">else</span></div>\n\
<div class=\"line\">            result += <span class=\"stringliteral\">&quot;8&quot;</span>;</div>\n\
<div class=\"line\">        result += <span class=\"stringliteral\">&quot; bits per channel\\n&quot;</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (reader.hasDepthMap ()) {</div>\n\
<div class=\"line\">        result += <span class=\"stringliteral\">&quot;Image has a depth map\\n&quot;</span>;</div>\n\
<div class=\"line\">    } <span class=\"keywordflow\">else</span> {</div>\n\
<div class=\"line\">        result += <span class=\"stringliteral\">&quot;Image does not have a depth map\\n&quot;</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html\">MStatus</a> iffInfo::redoIt()</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    clearResult();</div>\n\
<div class=\"line\">    appendToResult (result);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> MS::kSuccess;</div>\n\
<div class=\"line\">}</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    status = plugin.registerCommand( <span class=\"stringliteral\">&quot;iffInfo&quot;</span>, iffInfo::creator );</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    status = plugin.deregisterCommand( <span class=\"stringliteral\">&quot;iffInfo&quot;</span> );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!status)</div>\n\
