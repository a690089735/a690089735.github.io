...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script>\n\
      <title>C++ API Reference: createClipCmd/createClipCmd.cpp</title>\n\
      \n\
	  \n\
      \n\
      \n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>C++ API Reference: createClipCmd/createClipCmd.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"line\">        ~createClip() <span class=\"keyword\">override</span>;</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a9\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_string.html\">MString</a>         arg;</div>\n\
...
<div class=\"line\">        arg = args.<a name=\"a12\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html#ad24ff3826e4df513b55e1a0ecb0a665b\">asString</a>( i, &amp;stat );</div>\n\
...
<div class=\"line\">            args.<a name=\"a13\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_arg_list.html#adc169cdc872457a2664c3d66c29cf504\">get</a>(i, charName);</div>\n\
<div class=\"line\">            list.<a name=\"a14\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a23929aeafb29672f2652128eac9c4dec\">add</a>(charName);</div>\n\
...
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        <a name=\"_a15\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_it_selection_list.html\">MItSelectionList</a> iter (list);</div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <a name=\"_a18\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_character.html\">MFnCharacter</a> fnCharacter;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (fCharacter.isNull()) {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html\">MSelectionList</a> activeList;</div>\n\
<div class=\"line\">        <a name=\"a19\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_global.html#a6d81d38246555884897fb153c93aaf42\">MGlobal::getActiveSelectionList</a> (activeList);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (0 == activeList.<a name=\"a20\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_selection_list.html#a99dd6a54b909ede1d11702fe58977e2a\">length</a>()) {</div>\n\
...
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        fCharacter = fnCharacter.<a name=\"a21\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_set.html#a87bfaedb71c62c963e62881011e308ee\">create</a>(activeList,<a name=\"a22\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_set.html#a009e6a49ae66589e1bd624a5a8cf5044a634ee767a8e90ff4d56e140459cca31f\">MFnSet::kNone</a>,&amp;stat);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">if</span> (stat != MS::kSuccess) {</div>\n\
...
<div class=\"line\">        }</div>\n\
<div class=\"line\">    } <span class=\"keywordflow\">else</span> {</div>\n\
<div class=\"line\">        fnCharacter.<a name=\"a23\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_base.html#ad09f5acece0f9926b3e0e55cff78c3be\">setObject</a>(fCharacter);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <a name=\"_a24\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html\">MPlugArray</a> plugs;</div>\n\
<div class=\"line\">    fnCharacter.<a name=\"a25\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_character.html#a97df06964c339e37d5d0b50275f69e3c\">getMemberPlugs</a>(plugs);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <a name=\"_a26\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html\">MTime</a> start(0.0);</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_time.html\">MTime</a> duration(10.0);</div>\n\
<div class=\"line\">    <a name=\"_a27\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html\">MObjectArray</a> clipCurves;</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span> (count = 0; count &lt; plugs.<a name=\"a28\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug_array.html#a580388f31f60c46fac867ca48a48da1e\">length</a>(); ++count) {</div>\n\
...
<div class=\"line\">        <span class=\"comment\">//</span></div>\n\
<div class=\"line\">        <a name=\"_a29\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_anim_curve.html\">MFnAnimCurve</a> fnCurve;</div>\n\
<div class=\"line\"><span class=\"comment\">//      AnimCurveType plugType = fnCurve.timedAnimCurveTypeForPlug(plugs[count]);</span></div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> curve = fnCurve.<a name=\"a30\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_anim_curve.html#ac6f5d067bd54ad9dc9f51badf0d632bf\">create</a>(<a name=\"a31\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_anim_curve.html#a93c9cae782f401790431a8f034193f27a8031129808b47b18cc4121aa7c517757\">MFnAnimCurve::kAnimCurveTL</a>); <span class=\"comment\">// plugType);</span></div>\n\
<div class=\"line\">        fnCurve.<a name=\"a32\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_anim_curve.html#aee31f3bc493b091d404c8976ef743562\">addKeyframe</a>(start,5.0);</div>\n\
...
<div class=\"line\">        clipCurves.<a name=\"a33\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object_array.html#a3694392863ba632bca5d76cbbf190ef5\">append</a>(curve);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    </div>\n\
<div class=\"line\">    <span class=\"comment\">// Create a source clip node and add the animation to it</span></div>\n\
<div class=\"line\">    <span class=\"comment\">//</span></div>\n\
<div class=\"line\">    <a name=\"_a34\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_clip.html\">MFnClip</a> fnClipCreate;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> sourceClip = fnClipCreate.<a name=\"a35\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_clip.html#a3bbaf0793187391812b515d70ed3571f\">createSourceClip</a>(start,duration,fMod,&amp;stat);</div>\n\
<div class=\"line\">    fnCharacter.<a name=\"a36\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_character.html#ab61747aa1f7c9091905b0f968f3e8d14\">attachSourceToCharacter</a>(sourceClip,fMod);   </div>\n\
...
<div class=\"line\">        <a name=\"_a37\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_plug.html\">MPlug</a> animPlug = plugs[count];</div>\n\
<div class=\"line\">        fnCharacter.<a name=\"a38\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_character.html#a7c18e0cef72c725a85fe753ae5ae2d9f\">addCurveToClip</a>(clipCurves[count],sourceClip,animPlug,fMod);</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./cpp_ref/class_m_object.html\">MObject</a> instancedClip = fnClipCreate.<a name=\"a39\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_clip.html#a8019b55de186c1dda730ab8383312611\">createInstancedClip</a>(sourceClip,</div>\n\
<div class=\"line\">                                                             schedStart,</div>\n\
<div class=\"line\">                                                             fMod,</div>\n\
<div class=\"line\">                                                             &amp;stat);</div>\n\
<div class=\"line\">    fnCharacter.<a name=\"a40\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_character.html#ae5343c3de1b987a723f35a1dcbed6a58\">attachInstanceToCharacter</a>(instancedClip,fMod);</div>\n\
<div class=\"line\"></div>\n\
...
<div class=\"line\">    <a name=\"_a41\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_fn_plugin.html\">MFnPlugin</a> plugin( obj, PLUGIN_COMPANY, <span class=\"stringliteral\">&quot;4.0&quot;</span>, <span class=\"stringliteral\">&quot;Any&quot;</span>);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    status = plugin.registerCommand( <span class=\"stringliteral\">&quot;createClip&quot;</span>, createClip::creator );</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">if</span> (!status) {</div>\n\
<div class=\"line\">        status.<a name=\"a42\"></a><a class=\"code\" href=\"#!/url=./cpp_ref/class_m_status.html#a1f01a4748fea4d8bcced082df83f804d\">perror</a>(<span class=\"stringliteral\">&quot;registerCommand&quot;</span>);</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">return</span> status;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"keywordflow\">return</span> status;</div>\n\
